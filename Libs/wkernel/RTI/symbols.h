...
#define wkernel_Main_TYPE int (J3DAPI*)(HINSTANCE, HINSTANCE, LPSTR, int, LPCSTR)
#define wkernel_PeekProcessEvents_TYPE HRESULT (*)(void)
#define wkernel_ProcessEvents_TYPE HRESULT (*)(void)
...
#define wkernel_MainWndProc_TYPE LRESULT (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
