...
#define stdMath_aSinTable J3D_DECL_FAR_ARRAYVAR(stdMath_aSinTable, float(*)[4096])
#define stdMath_aTanTable J3D_DECL_FAR_ARRAYVAR(stdMath_aTanTable, float(*)[4096])
...
{
    float stdMath_aSinTable_tmp[4096] = {
      0.0f,
      0.00038300001f,
      0.00076700002f,
      0.00115f,
    ...
    memcpy(&stdMath_aSinTable, &stdMath_aSinTable_tmp, sizeof(stdMath_aSinTable));
    
    float stdMath_aTanTable_tmp[4096] = {
      0.0f,
      0.00038300001f,
      0.00076700002f,
      0.00115f,
    ...
    memcpy(&stdMath_aTanTable, &stdMath_aTanTable_tmp, sizeof(stdMath_aTanTable));
    
}

float J3DAPI stdMath_FlexPower(float base, int exponent)
{
    return J3D_TRAMPOLINE_CALL(stdMath_FlexPower, base, exponent);
}

float J3DAPI stdMath_NormalizeAngle(float angle)
{
    return J3D_TRAMPOLINE_CALL(stdMath_NormalizeAngle, angle);
}

float J3DAPI stdMath_NormalizeAngleAcute(float angle)
{
    return J3D_TRAMPOLINE_CALL(stdMath_NormalizeAngleAcute, angle);
}

// Calculate sinus and cosinus of value x
void J3DAPI stdMath_SinCos(float angle, float* pSinOut, float* pCosOut)
{
    J3D_TRAMPOLINE_CALL(stdMath_SinCos, angle, pSinOut, pCosOut);
}

float J3DAPI stdMath_Tan(float angle)
{
    return J3D_TRAMPOLINE_CALL(stdMath_Tan, angle);
}

float J3DAPI stdMath_ArcSin1(float angle)
{
    return J3D_TRAMPOLINE_CALL(stdMath_ArcSin1, angle);
}

float J3DAPI stdMath_ArcSin3(float angle)
{
    return J3D_TRAMPOLINE_CALL(stdMath_ArcSin3, angle);
}
...
{
    return J3D_TRAMPOLINE_CALL(stdMath_ArcTan4, x, y);
}

float J3DAPI stdMath_Dist2D1(float x, float y)
{
    return J3D_TRAMPOLINE_CALL(stdMath_Dist2D1, x, y);
}

float J3DAPI stdMath_Dist3D1(float x, float y, float z)
{
    return J3D_TRAMPOLINE_CALL(stdMath_Dist3D1, x, y, z);
}
