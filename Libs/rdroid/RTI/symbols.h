...
#define rdCache_GetFrameNum_TYPE int (J3DAPI*)()
...
#define rdMaterial_GetMipSize_TYPE size_t (J3DAPI*)(int, int, int)
...
#define rdClip_Face3WPVS_TYPE int (J3DAPI*)(rdClipFrustum*, rdVector3*, int)
...
#define rdClip_Face3GT_TYPE int (J3DAPI*)(const rdClipFrustum*, rdVector3*, rdVector2*, int)
#define rdClip_Face3GTOrtho_TYPE int (J3DAPI*)(const rdClipFrustum*, rdVector3*, rdVector2*, int)
...
#define rdClip_VerticesToPlane_TYPE void (J3DAPI*)(rdCacheProcEntry*, const rdVector3*, const rdVector2*, int)
