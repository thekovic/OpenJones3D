...
#define JonesHud_Close_TYPE int (*)(void)
...
#define JonesHud_Render_TYPE void (J3DAPI*)()
#define JonesHud_Update_TYPE void (J3DAPI*)(const SithWorld*)
#define JonesHud_SetCanvasSize_TYPE int (J3DAPI*)(int, int)
#define JonesHud_UpdateSinCosTable_TYPE void (J3DAPI*)()
#define JonesHud_UpdateHUDLayout_TYPE void (J3DAPI*)(unsigned int, unsigned int)
#define JonesHud_MenuOpen_TYPE void (J3DAPI*)()
...
#define JonesHud_ProcessMenuItems_TYPE void (J3DAPI*)()
#define JonesHud_MenuMoveLeft_TYPE void (J3DAPI*)()
#define JonesHud_MenuMoveRight_TYPE void (J3DAPI*)()
#define JonesHud_MenuMoveDown_TYPE void (J3DAPI*)()
#define JonesHud_SetSelectedMenuItem_TYPE void (J3DAPI*)(int, JonesHudMenuItem*)
#define JonesHud_MenuMoveUp_TYPE void (J3DAPI*)()
...
#define JonesHud_MenuActivateItem_TYPE void (J3DAPI*)()
#define JonesHud_ResetMenuItems_TYPE void (J3DAPI*)()
...
#define JonesHud_RenderInventoryItemChange_TYPE void (J3DAPI*)()
#define JonesHud_DrawMenuItemIcon_TYPE void (J3DAPI*)(const JonesHudMenuItem*, float)
...
#define JonesHud_GetHealthBarAlpha_TYPE float (J3DAPI*)()
#define JonesHud_SetHealthBarAlpha_TYPE void (J3DAPI*)(float)
#define JonesHud_CutsceneStart_TYPE void (J3DAPI*)(int)
#define JonesHud_EnableInterface_TYPE void (J3DAPI*)(int)
#define JonesHud_DrawCredits_TYPE int (J3DAPI*)(int, tSoundChannelHandle)
#define JonesHud_InitializeGameStatistics_TYPE void (J3DAPI*)()
#define JonesHud_RestoreGameStatistics_TYPE void (J3DAPI*)()
#define JonesHud_RestoreTreasuresStatistics_TYPE void (J3DAPI*)()
#define JonesMain_Startup_TYPE int (J3DAPI*)(const char*)
#define JonesMain_GameWndProc_TYPE int (J3DAPI*)(HWND, UINT, WPARAM, LPARAM)
...
#define JonesMain_HandleWMTimer_TYPE int (J3DAPI*)(HWND)
#define JonesMain_HandleWMKeydown_TYPE void (J3DAPI*)(HWND, WPARAM, int, unsigned int, int)
#define JonesMain_PrintQuickSave_TYPE void (*)(void)
#define JonesMain_HandleWMActivateApp_TYPE int (J3DAPI*)(HWND, WPARAM, LPARAM)
#define JonesMain_HandleWMActivate_TYPE LRESULT (J3DAPI*)(HWND, int, LPARAM, int)
#define JonesMain_OnAppActivate_TYPE void (J3DAPI*)(HWND, int)
#define JonesMain_HandleWMChar_TYPE void (J3DAPI*)(HWND, char)
#define JonesMain_HandleWMSysCommand_TYPE void (J3DAPI*)(HWND, WPARAM)
...
#define JonesMain_TogglePrintFramerate_TYPE int (J3DAPI*)()
...
#define JonesMain_ProcessEndLevel_TYPE int (*)(void)
#define JonesMain_SetBonusLevel_TYPE void (*)(void)
#define JonesMain_ShowEndCredits_TYPE void (*)(void)
#define JonesMain_Credits_TYPE int (*)(void)
#define JonesMain_IsOpen_TYPE int (*)(void)
...
#define JonesMain_CloseWindow_TYPE int (J3DAPI*)()
#define JonesMain_FilePrintf_TYPE int (*)(const char*, ...)
#define JonesMain_Printf_TYPE int (*)(const char*, ...)
#define JonesMain_RefreshDisplayDevice_TYPE void (*)(void)
#define JonesMain_PlayIntro_TYPE int (J3DAPI*)()
#define JonesMain_IntroWndProc_TYPE int (J3DAPI*)(HWND, UINT, WPARAM, LPARAM)
#define JonesMain_HandleWMLButtonUp_TYPE void (J3DAPI*)()
#define JonesMain_IntroHandleKeydown_TYPE void (J3DAPI*)(HWND, int)
#define JonesMain_IntroMovieBll565_TYPE signed int (J3DAPI*)(void*)
#define JonesMain_IntroMovieBlt555_TYPE signed int (J3DAPI*)(void*)
#define JonesMain_IntroMovieBlt32_TYPE int (J3DAPI*)(void*)
#define JonesMain_Assert_TYPE void (J3DAPI*)(const char*, const char*, int)
#define JonesMain_BindInventoryControlKeys_TYPE void (J3DAPI*)(const int*, int)
#define JonesMain_ResetHUD_TYPE void (J3DAPI*)()
#define JonesMain_SaveHUD_TYPE int (J3DAPI*)(DPID, unsigned int)
#define JonesMain_RestoreHUD_TYPE int (J3DAPI*)(const SithMessage*)
#define JonesMain_GetCurrentLevelNum_TYPE int (J3DAPI*)()
...
#define JonesMain_DevDialogProc_TYPE LRESULT (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
...
#define JonesMain_DevDialogUpdateRadioButtons_TYPE void (J3DAPI*)(HWND, JonesState*)
#define JonesMain_FindClosestVideoMode_TYPE int (J3DAPI*)(const StdDisplayEnvironment*, StdVideoMode*, size_t)
#define JonesMain_CurDisplaySupportsBPP_TYPE int (J3DAPI*)(JonesDisplaySettings*, int)
...
#define jonesCog_StartCutsceneImpl_TYPE void (J3DAPI*)(SithCog*)
#define jonesCog_EndCutscene_TYPE void (J3DAPI*)(SithCog*)
#define jonesCog_UpdateDifficulty_TYPE void (J3DAPI*)(SithCog*)
#define jonesCog_EnableInterfaceImpl_TYPE void (J3DAPI*)(SithCog*)
...
#define jonesConfig_InitDialogText_TYPE HFONT (J3DAPI*)(HWND, HFONT, int)
...
#define jonesConfig_SetWindowFontCallback_TYPE int (__stdcall*)(HWND, LPARAM)
#define jonesConfig_PositionAndSetTextCallback_TYPE BOOL (__stdcall*)(HWND, JonesDialogFontInfo*)
#define jonesConfig_sub_4045E0_TYPE void (J3DAPI*)(HWND, JonesDialogFontInfo*)
...
#define jonesConfig_ShowOverwriteSaveGameDlg_TYPE int (J3DAPI*)(HWND, char*)
...
#define jonesConfig_ShowLoadGameDialog_TYPE int (J3DAPI*)(HWND)
...
#define jonesConfig_sub_406A00_TYPE LRESULT (J3DAPI*)(HWND, HWND, int)
#define jonesConfig_GamePlayOptionsInitDlg_TYPE int (J3DAPI*)(HWND)
#define jonesConfig_GamePlayOptions_HandleWM_COMMAND_TYPE int (J3DAPI*)(HWND, int)
...
#define JonesDialog_DummyFlipGDI_TYPE int (J3DAPI*)()
...
#define jonesInventory_ResetGameStatistics_TYPE int (J3DAPI*)()
#define jonesInventory_GetMaxDifficultyLevel_TYPE int (J3DAPI*)()
