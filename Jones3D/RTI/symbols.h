...
#define jonesConfig_ShowSoundSettingsDialog_TYPE int (J3DAPI*)(HWND, JonesSoundSettingsDialogData*)
#define jonesConfig_SoundSettingsDialogProc_TYPE INT_PTR (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
#define jonesConfig_InitSoundSettingsDialog_TYPE int (J3DAPI*)(HWND, int, JonesSoundSettingsDialogData*)
