...
#define JonesHud_RenderHealthIndicator_TYPE int (J3DAPI*)(int)
...
#define JonesHud_RenderHealthIndicatorHit_TYPE void (J3DAPI*)(float)
...
#define JonesHud_ProcessInventoryMenu_TYPE void (*)(void)
...
#define JonesHud_BindActivateControlKeys_TYPE void (J3DAPI*)(const size_t*, size_t)
...
#define JonesHud_MenuExpandColumn_TYPE void (J3DAPI*)(JonesHudMenuItem*)
#define JonesHud_MenuCollapseColumn_TYPE void (J3DAPI*)(JonesHudMenuItem*)
...
#define JonesMain_BindToggleMenuControlKeys_TYPE void (J3DAPI*)(const size_t*, size_t)
...
#define jonesCog_ToggleInterface_TYPE void (J3DAPI*)(SithCog*)
#define jonesConfig_Startup_TYPE int (*)(void)
#define jonesConfig_InitKeySetsPath_TYPE int (*)(void)
#define jonesConfig_InitKeyActions_TYPE int (*)(void)
#define jonesConfig_Shutdown_TYPE void (*)(void)
#define jonesConfig_ControlToString_TYPE void (J3DAPI*)(size_t, char*)
...
#define jonesConfig_InitMessageDialogIcon_TYPE void (J3DAPI*)(HWND, JonesMessageDialogData *pData)
#define jonesConfig_InitMessageDialogData_TYPE int (J3DAPI*)(HWND, int, JonesMessageDialogData *pData)
#define jonesConfig_SetTextControl_TYPE int (J3DAPI*)(HWND, HWND, const char*)
#define jonesConfig_MessageDialog_HandleWM_COMMAND_TYPE void (J3DAPI*)(HWND, int)
#define jonesConfig_LoadActiveControlScheme_TYPE JonesControlsScheme* (*)(void)
#define jonesConfig_LoadControlScheme_TYPE int (J3DAPI*)(const char*, JonesControlsScheme*)
#define jonesConfig_ParseArgumentIndex_TYPE int (J3DAPI*)(size_t*, const StdConffileEntry*, size_t, const char**, size_t)
#define jonesConfig_GetStringListIndex_TYPE int (J3DAPI*)(char*, const char**, size_t)
#define jonesConfig_ParseJoystickControlId_TYPE int (J3DAPI*)(size_t*, const StdConffileEntry*)
#define jonesConfig_SetDefaultControlScheme_TYPE int (J3DAPI*)(JonesControlsScheme*, size_t)
#define jonesConfig_BindControls_TYPE void (J3DAPI*)(JonesControlsScheme*)
#define jonesConfig_BindJoystickControl_TYPE void (J3DAPI*)(SithControlFunction, size_t)
...
#define jonesConfig_SaveGameDialogInit_TYPE int (J3DAPI*)(HWND, int, LPOPENFILENAME)
...
#define jonesConfig_LoadGameDialogInit_TYPE int (J3DAPI*)(HWND, int, LPOPENFILENAME)
...
#define jonesConfig_CloneControlSchemesList_TYPE JonesControlsScheme* (J3DAPI*)(JonesControlsScheme*, size_t, size_t)
#define jonesConfig_ControlOptions_InitControlsConfig_TYPE int (*)(void)
#define jonesConfig_ControlOptions_LoadAllControlSchemes_TYPE int (J3DAPI*)(JonesControlsConfig*)
#define jonesConfig_ControlOptions_SetAllDefaultControlSchemes_TYPE int (J3DAPI*)(JonesControlsConfig*)
#define jonesConfig_ControlOptionsDialogProc_TYPE INT_PTR (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
#define jonesConfig_InitControlOptionsDialog_TYPE int (J3DAPI*)(HWND, int, JonesControlsConfig*)
#define jonesConfig_ControlOptions_HandleWM_COMMAND_TYPE void (J3DAPI*)(HWND, int, LPARAM, unsigned int)
#define jonesConfig_ControlOptions_WriteScheme_TYPE int (J3DAPI*)(JonesControlsScheme*)
#define jonesConfig_ControlOptions_UpdateButtons_TYPE int (J3DAPI*)(HWND)
#define jonesConfig_ControlOptions_DeleteScheme_TYPE void (J3DAPI*)(HWND, JonesControlsConfig*)
#define jonesConfig_ControlOptions_EditSelectedScheme_TYPE void (J3DAPI*)(HWND, JonesControlsConfig*)
#define jonesConfig_GetDefaultControlScheme_TYPE JonesControlsScheme* (J3DAPI*)(JonesControlsConfig*)
#define jonesConfig_ControlOptions_CreateNewScheme_TYPE void (J3DAPI*)(HWND, JonesControlsConfig*, JonesControlsScheme*)
#define jonesConfig_ShowCreateControlSchemeDialog_TYPE int (J3DAPI*)(HWND, void*)
#define jonesConfig_CreateControlSchemeProc_TYPE INT_PTR (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
#define jonesConfig_InitCreateControlScheme_TYPE int (J3DAPI*)(HWND, int, void*)
#define jonesConfig_CreateControlScheme_Handle_WM_COMMAND_TYPE void (J3DAPI*)(HWND, int)
#define jonesConfig_ShowEditControlShemeDialog_TYPE int (J3DAPI*)(HWND, void*)
#define jonesConfig_EditControlSchemeProc_TYPE INT_PTR (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
#define jonesConfig_InitEditControlSchemeDlg_TYPE int (J3DAPI*)(HWND, int, void*)
#define jonesConfig_EditControlScheme_SetListColumn_TYPE void (J3DAPI*)(HWND, const char*)
#define jonesConfig_EditControlScheme_SetListScheme_TYPE void (J3DAPI*)(HWND, int, JonesControlsScheme*)
#define jonesConfig_EditControlScheme_Handle_WM_COMMAND_TYPE void (J3DAPI*)(HWND, int)
#define jonesConfig_EditControlScheme_EditAssignment_TYPE void (J3DAPI*)(HWND, HWND, int, JonesControlsScheme*)
#define jonesConfig_EditControlScheme_GetSelectedListItemBinding_TYPE int (J3DAPI*)(HWND, HWND, JonesControlsScheme*, size_t*, size_t*)
#define jonesConfig_EditControlScheme_AddAssignment_TYPE void (J3DAPI*)(HWND, HWND, int, void*)
#define jonesConfig_EditControlScheme_DeleteAssignment_TYPE void (J3DAPI*)(HWND, HWND, int, JonesControlsScheme*)
#define jonesConfig_ShowAssignKeyDialog_TYPE int (J3DAPI*)(HWND, void*)
#define jonesConfig_AssignKey_CheckBindForKey_TYPE int (J3DAPI*)(JonesControlsScheme*, size_t, size_t*, int, size_t*)
#define jonesConfig_AssignKeyDlgProc_TYPE INT_PTR (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
#define jonesConfig_InitAssignKeyDlg_TYPE int (J3DAPI*)(HWND, int, uint32_t*)
#define jonesConfig_AssignControlKey_ReadKey_TYPE void (J3DAPI*)(HWND)
#define jonesConfig_AssignControlKey_ReadJoyAxisKey_TYPE int (J3DAPI*)(int)
#define jonesConfig_AssignKeyDlg_HandleWM_COMMAND_TYPE void (J3DAPI*)(HWND, int)
#define jonesConfig_ShowReassignKeyMsgBox_TYPE int (J3DAPI*)(HWND, void*)
#define jonesConfig_ReassignKeyDialogProc_TYPE INT_PTR (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
#define jonesConfig_InitReassignKeyDialog_TYPE int (J3DAPI*)(HWND, int, void*)
#define jonesConfig_ReassignKeyDlg_HandleWM_COMMAND_TYPE void (J3DAPI*)(HWND, unsigned int)
...
#define jonesConfig_InitDisplaySettingsDialog_TYPE int (J3DAPI*)(HWND, int, void*)
#define jonesConfig_DisplaySettings_GetVideoModeNum_TYPE int (J3DAPI*)(const void *, const char *, size_t)
#define jonesConfig_DisplaySettings_HandleWM_COMMAND_TYPE void (J3DAPI*)(HWND, int, LPARAM, int)
#define jonesConfig_ShowAdvanceDisplaySettings_TYPE int (J3DAPI*)(HWND, void*)
#define jonesConfig_AdvanceDisplaySettingsDialogProc_TYPE INT_PTR (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
#define jonesConfig_DisplaySettings_Get3DDeviceSupportsBPP_TYPE int (J3DAPI*)(const StdDisplayInfo *, const JonesDisplaySettings *, int)
#define jonesConfig_InitAdvanceDisplaySettingsDialog_TYPE void (J3DAPI*)(HWND, int, int, void*)
#define jonesConfig_AdvanceDisplaySettings_HandleWM_COMMAND_TYPE int (J3DAPI*)(HWND, int, int, int)
#define jonesConfig_ShowSoundSettingsDialog_TYPE int (J3DAPI*)(HWND, JonesSoundSettings*)
#define jonesConfig_SoundSettingsDialogProc_TYPE INT_PTR (__stdcall*)(HWND, UINT, WPARAM, LPARAM)
#define jonesConfig_InitSoundSettingsDialog_TYPE int (J3DAPI*)(HWND, int, JonesSoundSettings*)
#define jonesConfig_SoundSettings_HandleWM_COMMAND_TYPE void (J3DAPI*)(HWND, int, int)
...
#define jonesConfig_StoreSetListColumns_TYPE void (J3DAPI*)(HWND, const char*)
...
#define jonesInventory_Close_TYPE void (*)(void)
...
#define jonesInventory_AdvanceStatistics_TYPE void (J3DAPI*)(void)
#define jonesInventory_AdvanceFoundTreasuresStatistics_TYPE void (*)(void)
#define jonesInventory_UpdateGameTimeStatistics_TYPE void (J3DAPI*)(uint32_t)
#define jonesInventory_UpdateLevelStatisticTime_TYPE void (J3DAPI*)(uint32_t, SithLevelStatistic*, uint32_t, uint32_t)
#define jonesInventory_ResetStatisticsGameTime_TYPE void (*)(void)
