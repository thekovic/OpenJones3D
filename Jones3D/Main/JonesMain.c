...
{
    const JonesLevelInfo JonesMain_aCndLevelLoadInfos_tmp[18] = {
    ...
    memcpy((JonesLevelInfo *)&JonesMain_aCndLevelLoadInfos, &JonesMain_aCndLevelLoadInfos_tmp, sizeof(JonesMain_aCndLevelLoadInfos));
    
    const JonesLevelInfo JonesMain_aNdyLevelLoadInfos_tmp[18] = {
    ...
    memcpy((JonesLevelInfo *)&JonesMain_aNdyLevelLoadInfos, &JonesMain_aNdyLevelLoadInfos_tmp, sizeof(JonesMain_aNdyLevelLoadInfos));
    
    JonesMainProcessFunc JonesMain_pfProcess_tmp = &JonesMain_ProcessGame;
    memcpy(&JonesMain_pfProcess, &JonesMain_pfProcess_tmp, sizeof(JonesMain_pfProcess));
    
    char JonesMain_g_aErrorBuffer_tmp[1024] = {
      'U',
      'n',
      'k',
      'n',
